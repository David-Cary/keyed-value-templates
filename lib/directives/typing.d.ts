import { type KeyedTemplateResolver, type KeyValueMap, type KeyedTemplateDirective, type TemplateOptimizationResult, type TypeConversionCallback } from '../resolver/template-resolver';
/**
