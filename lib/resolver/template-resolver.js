...
var KeyedTemplateResolver = /** @class */ (function () {
    function KeyedTemplateResolver(directives, directivesKey, localVariablesKey, resolutionStateKey) {
        ...
        if (resolutionStateKey === void 0) { resolutionStateKey = '$resolving'; }
    ...
    KeyedTemplateResolver.prototype.resolveValues = function (value, context) {
        ...
        var subcontext = this.createChildStateContext(context, state);
    ...
    KeyedTemplateResolver.prototype.resolveObject = function (value, context) {
        ...
        if (directive != null) {
            var resolvedValue = this.resolveViaDirective(directive, value, context);
            return resolvedValue;
        }
        var copy = this.resolvePropertiesOf(value, context);
        return copy;
    };
    /**
     ...
     */
    KeyedTemplateResolver.prototype.resolvePropertiesOf = function (value, context) {
        if (context === void 0) { context = {}; }
        var copy = {};
        var state = {
            source: value,
     ...
     * @returns {unknown} version of the object with templates resolved
     */
    KeyedTemplateResolver.prototype.resolveViaDirective = function (directive, params, context) {
        ...
        var subcontext = this.createChildStateContext(context, state);
        var resolvedValue = directive.execute(params, subcontext, this);
        return resolvedValue;
    };
    /**
     ...
     */
    KeyedTemplateResolver.prototype.getResolutionState = function (context) {
        if (context === void 0) { context = {}; }
        var state = context[this.resolutionStateKey];
        var validated = this.validateResolutionState(state);
        return validated;
    };
    /**
     ...
     */
    KeyedTemplateResolver.prototype.setResolutionState = function (context, state) {
     ...
     * @returns {KeyValueMap} copy of the provided context with the target state data
     */
    KeyedTemplateResolver.prototype.createChildStateContext = function (context, state) {
        if (this.resolutionStateKey !== '') {
            this.setParentStateOf(state, context);
            var subcontext = __assign({}, context);
     ...
     */
    KeyedTemplateResolver.prototype.setParentStateOf = function (target, context) {
        if (context === void 0) { context = {}; }
        var parent = this.getResolutionState(context);
        if (parent != null) {
     ...
     */
    KeyedTemplateResolver.prototype.findResolutionState = function (context, callback) {
        var state = this.getResolutionState(context);
        while (state != null) {
     ...
     */
    KeyedTemplateResolver.prototype.traverseResolutionAncestry = function (context, callback) {
        var state = this.getResolutionState(context);
        while (state != null) {
            var signal = callback(state);
            if (signal === false)
                break;
            state = state.parent;
        }
     ...
     */
    KeyedTemplateResolver.prototype.validateResolutionState = function (value) {
        if (typeof value === 'object' &&
            value != null &&
            'source' in value &&
     ...
     */
    KeyedTemplateResolver.prototype.convertToRecord = function (source, valueKey) {
        var _a;
        if (valueKey === void 0) { valueKey = ''; }
        ...
        if (valueKey !== '') {
            return _a = {}, _a[valueKey] = source, _a;
        }
        return {};
    };
    /**
     ...
     */
    KeyedTemplateResolver.prototype.createDeepCopy = function (source, copyMap, path) {
        ...
        if (typeof source === 'object' && source != null) {
            ...
            for (var key in valueMap) {
                ...
                try {
                    ...
                    throw (new Error(JSON.stringify({ error: error.message, path: path, key: key })));
                }
                path.pop();
            }
            return result;
     ...
     */
    KeyedTemplateResolver.prototype.processParameter = function (source, key, process, state) {
        if (state != null)
            state.property = key;
